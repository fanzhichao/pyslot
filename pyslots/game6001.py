...
TUAN_QUANZHONG_LIST = ((20, 20, 15, 10, 8, 6,  8, 6, 0, 0),
                        (20, 20, 15, 15, 12, 10, 12, 10,5, 3),
                        (20, 20, 15, 15, 12, 10, 12, 10,8, 10),
                        (15, 15, 15, 15, 15, 12, 15, 12,5, 10),
                        (20, 20, 15, 15, 12, 10, 12, 10, 8, 20),
                        (20, 20, 15, 15, 12, 10, 12, 10, 8, 10))
# header区域的权重
HEADER_QUANZHONG = (20, 20, 15, 10, 8, 6,  8, 6, 0, 0)
...
BLOCK_TUAN_QUANZHONG = (20, 20, 15, 10, 8, 6, 8, 6, 5, 5)
...
REEL_LENGTH = 5  # 去掉header的matrix的高度，rows
...
if __name__ == '__main__':
    ...
    pprint("****package:"+PACKAGE_NAME + "总共需要 "+str(num) + "组组合")
    ...
    for i in range(10):
        ...
        pprint("4444****package:"+PACKAGE_NAME + "  ****funtion main: the "+ str(i) + str(result))
            ...
            for i, value in enumerate(pl_list):
                if pl_is_match(total_win, pl_list,i):
                    ...
                    if pl_get_num_list[i] < pl_need_num_list[i]:
                        ...
                        pprint("5555****package:"+PACKAGE_NAME + " 第 "+str(i)+"  有了 "+str(pl_get_num_list[i]))
